...
export const DEFAULT_COVERS: Cover[] = [
  { id: '1', title: 'Comfortably Numb',    bandName: 'Pink Floyd',     style: 'rock',       coverType: 'guitar-solo', instruments: ['guitar'], embedUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ', socialLinks: { YouTube: 'https://youtube.com', Instagram: 'https://instagram.com' } },
  ...
  { id: '3', title: 'Hallelujah',           bandName: 'Leonard Cohen', style: 'pop',        coverType: 'guitar',      instruments: ['guitar'], embedUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ' },
  { id: '4', title: 'Hotel California',     bandName: 'Eagles',        style: 'rock',       coverType: 'guitar-solo', instruments: ['guitar'], embedUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ' },
  ...
  { id: '6', title: 'Blackbird',            bandName: 'The Beatles',   style: 'rock',       coverType: 'guitar',      instruments: ['guitar'], embedUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ' },
  { id: '7', title: 'Clair de Lune',        bandName: 'Debussy',       style: 'classical',  coverType: 'piano',       instruments: ['piano'],  embedUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ' },
  { id: '8', title: 'Smells Like Teen Spirit', bandName: 'Nirvana',    style: 'grunge',     coverType: 'guitar',      instruments: ['guitar'], embedUrl: 'https://www.youtube.com/embed/dQw4w9WgXcQ' },
]
